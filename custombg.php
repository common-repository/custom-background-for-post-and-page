<?php
/*
Plugin Name: Custom Background for Post and Page
Plugin URI: http://wpexlored.com
...
add_action('post_edit_form_tag', 'post_edit_form_upload');
function post_edit_form_upload() {
